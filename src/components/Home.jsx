  ...
  return (
    ...
    <div id="hero" className="hero min-h-screen">
      ...
      <div className="text-center wht pt-12">
        <h1 className=" mb-6 text-6xl md:hidden font-bold font-cursive">E - Cell</h1>
        <h1 className=" mb-6 hidden md:flex text-8xl lg:text-8xl xl:text-9xl font-bold wht opening font-cursive">Entrepreneurship Cell</h1>
        <h4 className=" mb-16 text-3xl lg:text-3xl xl:text-4xl wht openingnav font-thin">PES University</h4>
        <button className="openingnav border rounded-md py-2 px-4 hover:bg-white duration-200 hover:text-black" onClick={scrollToAbout}>Explore</button>
      </div>
    </div>
